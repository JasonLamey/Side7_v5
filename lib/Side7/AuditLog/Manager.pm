package Side7::AuditLog::Manager;
...
=head2 make_manager_methods('object');
    ...
    $result = Side7::AuditLog::Manager->make_manager_methods();

TODO: Define what this method does, describing both input and output values and types.

=cut

sub object_class { 'Side7::AuditLog' }

__PACKAGE__->make_manager_methods('audit_logs');
