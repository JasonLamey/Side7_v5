package Side7::User::Country::Manager;
...
=head2 make_manager_methods('object');
    ...
    $result = Side7::User::Country::Manager->make_manager_methods();

TODO: Define what this method does, describing both input and output values and types.

=cut

sub object_class { 'Side7::User::Country' }
